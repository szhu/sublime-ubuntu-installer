...
INSTALL_EXE_REL = 'share/sublime-text-2/sublime_text'.replace('$<HOME>', HOME)
...
INSTALL_SUBL_DIR_REL = 'share/sublime-text-2'.replace('$<HOME>', HOME)
MAJOR_VERSION = 2
...
SYMLINK_TARGET = '../share/sublime-text-2/sublime_text'.replace('$<HOME>', HOME)
